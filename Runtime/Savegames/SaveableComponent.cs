...
{
    /// <summary>
    /// All components that you wish to be saved and loaded to/from savegames in some way should inherit ultimately from this base class.<para> </para>
    ///
    ...
    /// <seealso cref="GlitchedPolygons.SavegameFramework.Json.JsonSaveableComponent"/>
