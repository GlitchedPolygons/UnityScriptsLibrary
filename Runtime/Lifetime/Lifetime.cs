...
namespace GlitchedPolygons
{
    ...
    /// Useful if you want to trigger basic stuff happening in the scene on load without writing any code (just hook up stuff in the inspector <see cref="UnityEvent"/>).
    /// </summary>
